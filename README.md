...
FormSafe is an MVP designed for local testing, product demos, and portfolio review. It is not connected to any backend service and does not require an account.
